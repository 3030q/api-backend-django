# Generated by Django 3.2 on 2021-04-18 18:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('app', models.ForeignKey(db_column='app_id', on_delete=django.db.models.deletion.CASCADE, to='api.app')),
                ('integration_type', models.ForeignKey(db_column='integration_type_id', on_delete=django.db.models.deletion.CASCADE, to='api.integrationtype')),
